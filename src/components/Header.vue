  ...
  <header class="py-2 mb-3 border-bottom" style="cursor: pointer">
    ...
    >
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li>
          <router-link to="/finance" class="nav-link px-3 link-dark fs-6">风化物</router-link>
        </li> -->
        <li v-if="isLoggedIn">
          <router-link to="/creator" class="nav-link px-3 link-dark fs-6">创作者中心</router-link>
        </li>
            ...
            <li>
              <a @click="handleLogout" class="dropdown-item">
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  id="sign-out-double-arrow"
                  data-name="Flat Line"
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon flat-line me-2"
                >
                  <polyline
                    id="primary"
