  ...
  <header class="py-2 mb-3 border-bottom" style="cursor: pointer">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><router-link to="/finance" class="nav-link px-3 link-dark fs-6">风化物</router-link></li>
        <li v-if="isLoggedIn"><router-link to="/creator" class="nav-link px-3 link-dark fs-6">创作者中心</router-link>
        </li>
