        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <article class="content lh-lg py-3">
                    <p>
                        本文是一个 Bootstrap 5 和 Vue 3 实现的 Medium 风格文章详情页面示例。我们将会使用不同的 Bootstrap
                        组件，比如排版类、按钮和图片类，以打造一个简洁的用户体验。
                    </p>
                    <p>
                        Bootstrap 是一个流行的 CSS 框架，可以帮助开发者快速设计和实现响应式的网页。通过结合 Vue 3，可以实现更好的组件化和响应式的用户界面。
                    </p>

                    <blockquote class="blockquote my-4">
                        <p class="mb-0">“设计一个网页是创造性的过程，它将技术与艺术完美结合。”</p>
                        <footer class="blockquote-footer">UI设计师，<cite title="Source Title">李四</cite>
                        </footer>
                    </blockquote>
                    <p>
